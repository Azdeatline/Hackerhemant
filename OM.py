...
bot = telebot.TeleBot('7067469096:AAFxeU-uNISEh7DOC_cDM5afqKCaTvr9_ws')
# DEVELOPER --> @Az_deatline
# Admin user IDs
admin_id = ["5697421601"]
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "𝐔𝐧𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐓𝐨 𝐔𝐬𝐞 𝐏𝐥𝐞𝐚𝐬𝐞 𝐃𝐌 𝐭𝐨 @Az_deatline"
...
def show_command_logs(message):
    ...
    if user_id in allowed_user_ids and is_subscribed(user_id):
        ...
        response = "𝐔𝐧𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐓𝐨 𝐔𝐬𝐞 𝐏𝐥𝐞𝐚𝐬𝐞 DM TO ⁣𓆩‎7X𓆪 HACKER "
    bot.reply_to(message, response)
...
def show_admin_commands(message):
    ...
    if user_id in admin_id:
        ...
        response = "PAPA SE BAAT KAR = @Az_deatline."
        bot.reply_to(message, response)
...
@bot.message_handler(commands=['7X'])
def show_help(message):
    response = """𝐈 𝐊𝐍𝐎𝐖 𝐘𝐎𝐔 𝐂𝐎𝐌𝐌𝐀𝐍𝐃 𝐈𝐒 --> LX \n𝐁𝐔𝐓 𝐇𝐈𝐒 𝐁𝐎𝐓𝐒 𝐅𝐀𝐓𝐇𝐄𝐑  \n𝐎𝐖𝐍𝐄𝐑 𝐎𝐅⁣𓆩‎7X𓆪 HACKER.
"""
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.row(
        telebot.types.InlineKeyboardButton('Updates', url='https://t.me/+yNqNM-x_5R4zOTU1'),
        telebot.types.InlineKeyboardButton('Support', url='https://t.me/+yNqNM-x_5R4zOTU1')
    )
